...
struct s_sc
{
	...
	t_OrderQuantity32_64 BuyEntry(s_SCNewOrder& NewOrder, int DataArrayIndex)// Manual looping
	{
		return InternalBuyEntry(NewOrder, DataArrayIndex);
	}

	t_OrderQuantity32_64 BuyEntry(s_SCNewOrder& NewOrder)//Automatic looping
	{
		return InternalBuyEntry(NewOrder, Index);
	}

	t_OrderQuantity32_64 BuyOrder(s_SCNewOrder& r_NewOrder, int DataArrayIndex)//Manual looping
	{
	...
	t_OrderQuantity32_64 BuyOrder(s_SCNewOrder& r_NewOrder)//Automatic looping
	{
		return BuyOrder(r_NewOrder, this->Index);
	}

	t_OrderQuantity32_64 BuyExit(s_SCNewOrder& NewOrder, int DataArrayIndex)// Manual looping
	{
		return InternalBuyExit(NewOrder, DataArrayIndex);
	}

	t_OrderQuantity32_64 BuyExit(s_SCNewOrder& NewOrder)//Automatic looping
	{
		return InternalBuyExit(NewOrder, Index);
	}

	t_OrderQuantity32_64 SellEntry(s_SCNewOrder& NewOrder, int DataArrayIndex)// Manual looping
	{
		return InternalSellEntry(NewOrder, DataArrayIndex);
	}

	t_OrderQuantity32_64 SellEntry(s_SCNewOrder& NewOrder)//Automatic looping
	{
		return InternalSellEntry(NewOrder, Index);
	}

	t_OrderQuantity32_64 SellOrder(s_SCNewOrder& r_NewOrder, int DataArrayIndex)//Manual looping
	{
		// For different Symbol or Trade Account
		if ((!r_NewOrder.Symbol.IsEmpty()
			&& (r_NewOrder.Symbol.CompareNoCase(GetTradeSymbol()) != 0))
	...
	t_OrderQuantity32_64 SellOrder(s_SCNewOrder& r_NewOrder)//Automatic looping
	{
		return SellOrder(r_NewOrder, this->Index);
	}

	t_OrderQuantity32_64 SellExit(s_SCNewOrder& NewOrder, int DataArrayIndex)// Manual looping
	{
		return InternalSellExit(NewOrder, DataArrayIndex);
	}

	t_OrderQuantity32_64 SellExit(s_SCNewOrder& NewOrder)//Automatic looping
	{
		return InternalSellExit(NewOrder, Index);
	}

	t_OrderQuantity32_64 SubmitOCOOrder(s_SCNewOrder& NewOrder)//Automatic looping
	{
