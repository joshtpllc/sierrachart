...
struct s_ACSTradeStatistics
{
	...
	double  TotalPercentProfitable() { return TotalTrades() == 0 ? 0 : static_cast<double>(TotalWinningTrades) / static_cast<double>(TotalTrades()); }
	int		TotalLongTrades;
	...
	double  AvgQuantityPerTrade() { return TotalTrades() == 0 ? 0 : static_cast<double>(TotalClosedQuantity()) / static_cast<double>(TotalTrades()); }
	double  AvgQuantityPerWinningTrade() { return TotalWinningTrades == 0 ? 0 : static_cast<double>(TotalWinningQuantity) / static_cast<double>(TotalWinningTrades); }
	double  AvgQuantityPerLosingTrade() { return TotalLosingTrades == 0 ? 0 : static_cast<double>(TotalLosingQuantity) / static_cast<double>(TotalLosingTrades); }
...
struct s_ACSTrade
{
	...
	t_OrderQuantity32_64 TradeQuantity = 0;
	t_OrderQuantity32_64 MaxClosedQuantity = 0;// Max closed quantity.
